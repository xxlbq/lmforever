...
//
//import cn.bestwiz.jhf.core.dao.admin.CustomerDao;
//import cn.bestwiz.jhf.core.dao.admin.MailDao;
...
//
//    private MailDao m_mailDao = MiddleDAOFactory.getMailMainDao();// 邮件操作dao类
//
//    private cn.bestwiz.jhf.core.dao.admin.CashflowDao m_cashflowDao = DAOFactory.getCashflowDao();//
//    // 用户金额操作dao类
//    //
...
//	  	try {
//	  		originalPassword = cn.bestwiz.jhf.core.service.admin.AccountService.encodeOriginalPassword(password);
