...
//
//  public class BufferContent  implements 
//               StyledTextContent {
...
//                           && lineOffsets.isLineDelimiter(charAt(endPos - 1))) {
//                       endPos--;
//                   }
//               }
//
...
//                       + "\n" + "replaceLineCount: "
//                       + changingEvent.replaceLineCount + "\n" + "text: "
//                       + printable(changingEvent.newText) + "\n");
//           }
//
//           /**
//            * @param start
...
//            * @return
//            */
//           private TextChangingEvent makeTextChangingEvent(int start,
...
//               result.replaceLineCount = lineOffsets.linesInRange(
//                       pos2offset(start), pos2offset(start + length));
//
//               return result;
//           }
//
...
//               for (Iterator iter = textChangeListeners.iterator(); iter
//                       .hasNext();) {
...
//               for (Iterator iter = textChangeListeners.iterator(); iter
//                       .hasNext();) {
//                   TextChangeListener element = (TextChangeListener) iter
//                           .next();
...
//               int lineStartOffset = lineOffsets.index2offset(lineOffsets
//                       .offset2index(offset));
