...
*/
public class CustomerBuilderView extends org.eclipse.swt.widgets.Composite {
...
//	private int orderProcessInit = 0;
	...
	public CustomerBuilderView(Composite parent, int style) {
		super(parent, style);
		initGUI();
		...
		try {
			...
			this.setLayout(thisLayout);
			{
				...
				composite1.setLayout(null);
				{
					...
					group1.setText("Customer Basic Info");
