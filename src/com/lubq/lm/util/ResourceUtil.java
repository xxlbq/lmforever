...
public class ResourceUtil {
    private static final FontRegistry fRegistry = JFaceResources
            .getFontRegistry();

    static {
        fRegistry.put(GlobalConstants.FONT_KEY_MSPGOTHIC8,
                new FontData[] { new FontData("MS PGothic", 8, SWT.NORMAL) });
        fRegistry.put(GlobalConstants.FONT_KEY_MSPGOTHIC9,
                new FontData[] { new FontData("MS PGothic", 9, SWT.NORMAL) });
        fRegistry.put(GlobalConstants.FONT_KEY_MSPGOTHIC18,
                new FontData[] { new FontData("MS PGothic", 18, SWT.BOLD) });
        fRegistry.put(GlobalConstants.FONT_KEY_MSPGOTHIC12,
                new FontData[] { new FontData("MS PGothic", 12, SWT.NORMAL) });
    }

    private static final ColorRegistry cRegistry = JFaceResources
            .getColorRegistry();
    ...
    static {
        ...
        cRegistry.put(GlobalConstants.COLOR_KEY_YELLOW, Display.getCurrent()
                .getSystemColor(SWT.COLOR_YELLOW).getRGB());
        cRegistry.put(GlobalConstants.COLOR_KEY_CYAN, new RGB(0, 128, 255));
        cRegistry.put(GlobalConstants.COLOR_KEY_GREEN, Display.getCurrent()
        ...
        cRegistry.put(GlobalConstants.COLOR_KEY_BABYBLUE,
                new RGB(140, 198, 255));
        cRegistry.put(GlobalConstants.COLOR_KEY_GRAY, Display.getCurrent()
                .getSystemColor(SWT.COLOR_GRAY).getRGB());
        cRegistry.put(GlobalConstants.COLOR_KEY_BABYGREEN, new RGB(235, 241,
                224));
        cRegistry.put(GlobalConstants.COLOR_KEY_HEAVYBLUE, new RGB(0, 0, 153));
        cRegistry.put(GlobalConstants.COLOR_KEY_WIDGET_BACKGROUND, Display
                .getCurrent().getSystemColor(SWT.COLOR_WIDGET_BACKGROUND)
                .getRGB());
        cRegistry.put(GlobalConstants.COLOR_KEY_WIDGET_DARKSHADOW, Display
                .getCurrent().getSystemColor(SWT.COLOR_WIDGET_DARK_SHADOW)
                .getRGB());

    }

    private static final ColorRegistry cRegistryFont = JFaceResources
            .getColorRegistry();

    static {
        cRegistryFont.put(GlobalConstants.COLOR_KEY_WHITE, new RGB(255, 255,
                255));
        cRegistryFont.put(GlobalConstants.COLOR_KEY_BLACK, new RGB(0, 0, 0));
    }

    private static final ImageRegistry iRegistry = JFaceResources
            .getImageRegistry();

    static {
        iRegistry.put(GlobalConstants.IMAGE_KEY_FXICON, OriginalImageDescriptor
                .createFromURL(ResourceUtil.class
                        .getResource(GlobalConstants.RESOURCE_PATH
                                + "images/fxicon.gif")));
        iRegistry.put(GlobalConstants.IMAGE_KEY_CHB_CHECKED,
                OriginalImageDescriptor.createFromURL(ResourceUtil.class
                        .getResource(GlobalConstants.RESOURCE_PATH
                                + "images/chb_checked.gif")));
        iRegistry.put(GlobalConstants.IMAGE_KEY_CHB_UNCHECKED,
                OriginalImageDescriptor.createFromURL(ResourceUtil.class
                        .getResource(GlobalConstants.RESOURCE_PATH
                                + "images/chb_unchecked.gif")));
        iRegistry.put(GlobalConstants.IMAGE_KEY_POINT, OriginalImageDescriptor
                .createFromURL(ResourceUtil.class
                        .getResource(GlobalConstants.RESOURCE_PATH
                                + "images/point.GIF")));
    }
    ...
    public static void registerImage(String imageKey, String image) {
        iRegistry.put(imageKey, OriginalImageDescriptor
                .createFromURL(ResourceUtil.class
                        .getResource(GlobalConstants.RESOURCE_PATH + "images/"
                                + image)));
    }
    ...
    public static Color getColorByCp(String counterpartyId) {
        ...
        return cRegistry.get(GlobalResources.GlobalResource
                .getString(counterpartyId));
    }
    ...
    public static Color getFontColorByCp(String counterpartyId) {
        ...
        return cRegistryFont.get(GlobalResources.GlobalResource
                .getString(counterpartyId + "Font"));
    }
